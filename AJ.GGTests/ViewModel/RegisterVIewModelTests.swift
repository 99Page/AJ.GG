...
final class RegisterVIewModelTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        viewModel = RegisterSummonerViewModel(summonerService: SummonerService(), leagueV4Service: LeagueV4Serivce(), matchV5Service: MatchV5Service(), summonerManager: SummonerManager(preview: true))
    }
